...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "focus:bg-accent data-[state=open]:bg-accent outline-none flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm",
      inset && "pl-8",
      className
    )}
    {...props}
    ...
    <span className="absolute left-2 flex size-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden>
          <path d="M20.285 6.709a1 1 0 0 0-1.414-1.414l-9.192 9.192-4.243-4.243a1 1 0 1 0-1.414 1.414l5 5a1 1 0 0 0 1.414 0l10-10z" />
        </svg>
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
