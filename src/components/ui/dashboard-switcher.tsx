...
export default function DashboardSwitcher({ items, className }: Props) {
  ...
  return (
    <div className={cn("relative w-full", className)}>
      {/* Container card */}
      <div className="relative rounded-3xl border border-[#111621]/5 bg-white/60 shadow-[0_10px_30px_rgba(17,22,33,0.05)] backdrop-blur-md dark:border-white/10 dark:bg-[#090D14]/95">
        {/* Segmented control */}
        <div className="flex w-full justify-center px-4 pt-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#111621]/10 bg-white/70 p-1 backdrop-blur-sm dark:border-white/10 dark:bg-[#090D14]/80">
            {items.map((it) => {
        ...
        <div className="relative mx-auto mt-4 w-full max-w-5xl px-4 pb-10">
          ...
          <div className="relative w-full overflow-hidden rounded-2xl border border-[#111621]/5 bg-white/80 shadow-md ring-1 ring-[#111621]/5 dark:border-white/10 dark:bg-[#090D14] dark:ring-white/10">
